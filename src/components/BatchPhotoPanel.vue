...
<template>
    <InspectorSection title="照片列表" section-class="batch-photo-panel">
        <div class="batch-actions inspector-content-contained inspector-action-grid">
        ...
        <div class="batch-summary inspector-content-contained inspector-muted-block">
        ...
        <div v-if="photos.length" class="batch-photo-list inspector-content-contained">
            ...
            >
                <button
                    class="batch-photo-select-button button-reset"
                    type="button"
